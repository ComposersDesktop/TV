...
static Rule r_close_storefiles = {"close_storefiles", 0, 0, 0, 0, e_close_storefiles, 0, c_close_storefiles };
...
struct keytab keytab[] = {
	...
	{	"close_storefiles", 0,		&r_close_storefiles, 0	},
